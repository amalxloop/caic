...
from caic.constants import OK, ERROR, EXCLUDED_FILE_SYSTEM_TYPES, FILE_SYSTEM_TYPES
from caic.utilities import configuration
...
def setup(action, old_page=None):
    ...
    if action == 'open':
        ...
        #     it is set to the current Cubic version in caic_wizard
        ...
        # functions that remove the ★ once the site has been visited.
        ...
        #     if new_text: displayer.set_button_label('wiki_menu_button', new_text)
...
def leave(action, new_page=None):
    ...
    if action == 'next':
        ...
        #    - Set to the running Cubic version in caic_wizard
        ...
        # 6. model.project.custom_root_directory
        #    - Set in the initialize_model() function
        # 7. mo8del.project.custom_live_directory
        #    - Set in the initialize_model() function
        # 8. model.project.custom_temp_directory
        #    - Set in the initialize_model() function
        # 9. model.project.custom_disk_directory
...
def validate_page():
    ...
    #    - Set in the validate_page() function
    # 8. model.project.custom_live_directory
    #    - Set in the initialize_model() function
    # 9. model.project.custom_temp_directory
    #    - Set in the validate_page() function
    # 10. model.project.custom_disk_directory
    #    - Set in the validate_page() function
    #
    ...
    # logger.log_value('The project custom live directory is', model.project.custom_live_directory)
    ...
    if version.parse(cubic_version) < version.parse(CONFIG_VERSION_2026):
...
def initialize_model():
    ...
    # The following must be set on the Project page or the Extract page.
