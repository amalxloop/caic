...
from caic.constants import SLEEP_0125_MS, SLEEP_0250_MS, SLEEP_0500_MS, SLEEP_1000_MS
...
from caic.utilities.processor import execute_synchronous, execute_asynchronous
...
def _update_kernel_details_list(kernel_details_list):
    ...
    kernel_details_list.sort(
        key=lambda details: [(0, 0, 0, 0) if k == 'version_integers' and v is None else '' if v is None else v for k, v in details.items()],
        reverse=True)
