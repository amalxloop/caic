...
def create_file_details_list(uris):
    ...
    for file_number, uri in enumerate(uris):
        file_path = urllib.parse.unquote(urllib.parse.urlsplit(uri).path)
...
def copy_file(file_path, file_number, directory, total_files):
    ...
    def progress_callback(percent):
        ...
        displayer.update_list_store_progress_bar_percent('preseed_copy_page__file_details__list_store', file_number, 0, percent)
