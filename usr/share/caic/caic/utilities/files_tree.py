...
from caic.utilities.displayer import MONOSPACE_FONT, SOURCE_LANGUAGE, SOURCE_STYLE_SCHEME
...
TREE_VIEW_UI_FILE_PATH = os.path.join(model.application.directory, 'caic', 'utilities', 'tree_view.ui')
SOURCE_VIEW_UI_FILE_PATH = os.path.join(model.application.directory, 'caic', 'utilities', 'source_view.ui')
